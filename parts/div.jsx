    ...
    return(
        <div className={styles.div1}>
            <div className="row mt-5 pt-5 mb-5 pb-5 w-100 text-center">
                <div className="col-xs-12 col-sm-12 col-md-6 col-lg-6 my-auto mx-auto text-center">
                ...
                <div className="col-xs-12 col-sm-12 col-md-6 col-lg-6 my-auto mx-auto text-center d-flex align-items-center justify-content-center">
